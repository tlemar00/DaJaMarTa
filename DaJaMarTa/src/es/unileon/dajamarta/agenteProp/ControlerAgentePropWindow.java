...
public class ControlerAgentePropWindow implements ActionListener, KeyListener{
	...
	public void rellenaDatosComponentes() {
		...
		String provincias[] = {"Alava","Albacete","Alicante","AlmerÃ­a","Asturias","Avila","Badajoz","Barcelona","Burgos","CÃ¡ceres",
	               "CÃ¡diz","Cantabria","Castellón","Ciudad Real","Córdoba","La CoruÃ±a","Cuenca","Gerona","Granada","Guadalajara",
	               "GuipÃºzcoa","Huelva","Huesca","Islas Baleares","JaÃ©n","León","LÃ©rida","Lugo","Madrid","MÃ¡laga","Murcia","Navarra",
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		}else if(arg0.getActionCommand().equals("Ayuda")) {JOptionPane.showMessageDialog(null, "En esta página podrás: \n "
