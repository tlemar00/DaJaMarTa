 ...
 *
 */
public class AgentePropiedadesWindow {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AgentePropiedadesWindow window = new AgentePropiedadesWindow();
	 ...
	 */
	public AgentePropiedadesWindow() {
		initialize();
	}
	...
	private void initialize() {
		...
		for (int i = 0; i < 1; i ++) {
			for(int j = 0; j < 8; j++) {
				...
				JLabel lblNewLabel = new JLabel("Propiedades");
